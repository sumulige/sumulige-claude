 ...
 * Supports: Claude Code, Codex CLI, OpenCode, Aider, Cursor, Cline, Trae, Zed
 */
...
const { ClineAdapter } = require('./cline-adapter');
const { TraeAdapter } = require('./trae-adapter');
const { ZedAdapter } = require('./zed-adapter');
